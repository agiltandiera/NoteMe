...
import com.tandiera.project.noteme.db.DbContract.MyTask.Companion.TASK_ID
import com.tandiera.project.noteme.db.DbContract.MyTask.Companion.TASK_IS_COMPLETE
...
class DbHelper(context: Context?)
    ...
    companion object{
        ...
        const val QUERY_CREATE_TASK = "CREATE TABLE ${DbContract.MyTask.TABLE_TASK}" +
